...
export default function DraftRoom({
    ...
    useEffect(() => {
        ...
        if (roleSelected !== Role.none) {
            ...
            if (roleSelected === Role.jungle)
                roleFiltered = champRoles.all.jungle;
            if (roleSelected === Role.mid) roleFiltered = champRoles.all.mid;
            if (roleSelected === Role.ad) roleFiltered = champRoles.all.adc;
            if (roleSelected === Role.support)
    ...
    const renderIcons = () => {
        return filterChampions.map((name: string, index: number) => {
            return (
                <div
                    key={name}
            ...
            {draftData && (
                <div className="flex flex-col bg-black min-h-screen">
                    <div className="w-full bg-gray-500 border-black border-y-2 h-[100px] flex flex-row justify-between items-center px-10">
                        <h1>{draftData.team1}</h1>
                        <h1 className="text-2xl">0 - 0</h1>
                        <h1>{draftData.team2}</h1>
                    </div>
                        ...
                        <div className=" flex flex-col w-[300px]">
                            <div className=" border-t-2 border-r-2 border-gray-600 flex-1 ">
                                {draftStep == 6 && selectedPick ? (
                                    ...
                                    <SplashArt name={blueTeamPicks[0]} />
                                ) : null}
                            </div>
                            <div className=" border-t-2 border-r-2 border-gray-600 flex-1 ">
                                {draftStep == 9 && selectedPick ? (
                                    ...
                                    <SplashArt name={blueTeamPicks[1]} />
                                ) : null}
                            </div>
                            <div className=" border-t-2 border-r-2 border-gray-600 flex-1 ">
                                {draftStep == 10 && selectedPick ? (
                                    ...
                                    <SplashArt name={blueTeamPicks[2]} />
                                ) : null}
                            </div>
                            <div className=" border-t-2 border-r-2 border-gray-600 flex-1 ">
                                {draftStep == 17 && selectedPick ? (
                                    ...
                                    <SplashArt name={blueTeamPicks[3]} />
                                ) : null}
                            </div>
                            <div className=" border-t-2 border-r-2 border-gray-600 flex-1 ">
                                {draftStep == 18 && selectedPick ? (
                                    ...
                                    <SplashArt name={blueTeamPicks[4]} />
                                ) : null}
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            <div className=" flex flex-row justify-between w-[731px]">
                                <div className=" flex flex-row w-[250px] justify-between items-center">
                                    ...
                                    <div
                                        className="bg-[#40865d] flex flex-col align-middle w-[40px] h-[40px]"
                                        onClick={() => handleRoleClick(Role.ad)}
                                    >
                                        <Image
                                            src={adIcon}
                                            alt="ADC"
