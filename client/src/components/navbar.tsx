    ...
    return(
        <nav className="bg-black text-white h-[134px] fixed top-0 left-0 w-full flex items-center">
                ...
                <ul className="flex gap-34 text-lg font-normal ml-auto mr-10">
                    <li className="cursor-pointer hover:underline text-center" onClick={() => router.push('/draft')}>DRAFT <br /> TOOL</li>
                    <li className="cursor-pointer hover:underline" onClick={() => router.push('/')}>ABOUT</li>
                    <li className="cursor-pointer hover:underline" onClick={() => router.push('/')}>JOIN</li>
                </ul>
        </nav>
    );
}
